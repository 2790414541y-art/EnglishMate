...
No React, Vue, backend, database, or real AI API is used.

## Project Status

**MVP Prototype**

This demo does not connect to a real AI API. It uses mock data to demonstrate the product flow and interaction logic.

当前版本重点是展示产品思路和核心体验，而不是实现真实 AI 能力。
